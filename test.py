...
tf.app.flags.DEFINE_string('load_weights','','The location of weights that you want to test with.')

if not FLAGS.load_weights:
    print("Have to give the location of weights.")
    print("Exiting")
    sys.exit()
...
# Change the weights path according to the model you want to evaluate.

model.load_weights(FLAGS.load_weights)
